...
// Copyright (c) 2011-2015 The SPOTS developers
...
// testnet dns seed begins with 't', all else are SPOTS dns seeds.
static const char *strDNSSeed[][2] = {
    {"seed", "spots.freestaking.com"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // SPOTS enables dns seeding with testnet too
    {
...
void StartNode(void* parg)
{
    ...
    // SPOTS: mint proof-of-stake blocks in the background
