...
// Copyright (c) 2012-2013 The SPOTS developers
...
// SPOTS version - intended for display purpose only
#define SPOTS_VERSION_MAJOR       1
#define SPOTS_VERSION_MINOR       0
#define SPOTS_VERSION_REVISION    0
#define SPOTS_VERSION_BUILD       0

static const int SPOTS_VERSION =
                           1000000 * SPOTS_VERSION_MAJOR
                         +   10000 * SPOTS_VERSION_MINOR
                         +     100 * SPOTS_VERSION_REVISION
                         +       1 * SPOTS_VERSION_BUILD;

// SPOTS version - reference for code tracking
