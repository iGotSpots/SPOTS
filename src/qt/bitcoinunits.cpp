...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SPOTS");
    case mBTC: return QString("mSPOTS");
    case uBTC: return QString::fromUtf8("μSPOTS");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("SPOTS");
    case mBTC: return QString("Milli-SPOTS (1 / 1,000)");
    case uBTC: return QString("Micro-SPOTS (1 / 1,000,000)");
    default: return QString("???");
    }
}
