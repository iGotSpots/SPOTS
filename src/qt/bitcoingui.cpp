 ...
 * The SPOTS Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("SPOTS Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/SPOTS_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/SPOTS_tooltip"), tr("&About SPOTS"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/SPOTS_tooltip"), tr("Show/Hide &SPOTS"), this);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/SPOTS_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/SPOTS_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/SPOTS_tooltip"));
            }
        }
