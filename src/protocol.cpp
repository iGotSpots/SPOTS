...
// SPOTS message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0x1a, 0x1b, 0x1c, 0x1d };
static unsigned char pchMessageStartSPOTS[4] = { 0xa1, 0xb2, 0xc3, 0xd4 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartSPOTS : pchMessageStartBitcoin, sizeof(pchMessageStartSPOTS));
}
