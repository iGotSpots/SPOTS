SPOTS 0.1.2
Copyright (c) 2014 SPOTS developers
...
About SPOTS
---------------
SPOTS is a SPOTS network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the SPOTS reference
wallet (http://github.com/SPOTS/SPOTS). 

To help faciliate broad community cooperation, a number of trusted 
SPOTS/Peershares community leaders have write permissions to the project's 
...
Resources
---------
SPOTS source code: https://github.com/SPOTS/SPOTS

For the most current instructions covering how to compile SPOTS from 
source on a variety of operating systems, please visit:
https://github.com/SPOTS/SPOTS/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/SPOTS/SPOTS/issues?state=open

SPOTS discussion forums (hosted by SPOTSTalk.org): 
http://www.SPOTStalk.org/index.php?board=64.0



Acknowledgements
----------------
SPOTS owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	SPOTS (SPOTS) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	SPOTS is a free open source project with the goal of providing a 
